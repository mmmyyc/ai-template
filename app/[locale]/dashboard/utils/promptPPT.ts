...
- 阶段2 - 幻灯片制作:
  - 目标: 根据生成的大纲创建单页HTML演示幻灯片，确保核心内容在1280px宽度内完整清晰地呈现，高度允许小部分溢出，文本使用${language}
