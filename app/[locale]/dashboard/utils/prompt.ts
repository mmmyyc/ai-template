...
<body class="bg-gray-50 flex justify-center items-center min-h-screen p-5">
  <!-- 卡片容器 -->
  <div class="w-[750px] bg-white rounded-xl shadow-xl concept-card">
    <div class="p-10 flex flex-col">
      ...
      <footer class="mt-8 pt-6 border-t border-gray-200 text-lg text-gray-500">
        <!-- 来源信息 -->
      </footer>
    </div>
  </div>
