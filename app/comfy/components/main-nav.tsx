...
export function MainNav() {
  ...
  const apps = [
    { id: 'image-gen', name: 'Image Generation', icon: Image, href: '/image-generation' },
    { id: 'text-gen', name: 'Text Generation', icon: Layers, href: '/text-generation' },
    { id: 'chat', name: 'Chat', icon: Send, href: '/chat' },
          ...
          {apps.map((app) => (
            <SidebarMenuItem key={app.id}>
              <Link href={app.href} passHref>
                <SidebarMenuButton isActive={pathname === app.href || (app.href === '/image-generation' && pathname === '/')}>
