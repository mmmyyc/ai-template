    ...
    <div className="w-full">
      ...
      <section className="py-20 px-4 bg-base-200/30">
        <div className="container mx-auto max-w-5xl text-center">
          ...
          <p className="text-base-content/60 mb-16 max-w-2xl mx-auto">
            {t('stepsDescription')}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step, index) => (
              ...
              >
                <div className="w-16 h-16 rounded-full flex items-center justify-center bg-primary/10 mb-5 text-primary">
                  {step.icon}
                </div>
                <h3 className="text-lg font-medium mb-2 text-base-content">{t(step.titleKey)}</h3>
        ...
        <div className="container mx-auto max-w-5xl text-center">
          ...
          <div className="relative max-w-4xl mx-auto px-10">
            <div className="overflow-hidden">
              ...
              >
                {advancedFeatures.map((feature, index) => (
                  ...
                  >
                    <div className="bg-base-200/50 rounded-xl p-6 md:p-8 h-full flex flex-col items-center text-center transition-all duration-300 hover:bg-base-200/80">
                      <div className="w-16 h-16 rounded-full flex items-center justify-center bg-base-100 mb-5 text-primary">
                        {feature.icon}
                      </div>
                      <h3 className="text-lg font-medium mb-3 text-base-content">{t(feature.titleKey)}</h3>
            ...
            <button 
              ...
              className="absolute left-0 top-1/2 -translate-y-1/2 bg-base-100 rounded-full w-9 h-9 flex items-center justify-center shadow-md text-base-content/70 hover:text-primary border border-base-300"
            ...
            <button 
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 bg-base-100 rounded-full w-9 h-9 flex items-center justify-center shadow-md text-base-content/70 hover:text-primary border border-base-300"
            ...
            {advancedFeatures.map((_, index) => (
              <button
                ...
                className={`transition-all duration-300 rounded-full ${
                  activeFeature === index 
                    ? 'bg-primary w-5 h-2' 
                    : 'bg-base-300 w-2 h-2 hover:bg-base-content/30'
                }`}
